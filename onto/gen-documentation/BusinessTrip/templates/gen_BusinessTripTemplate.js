  ...
  <div>
    <div class="container sheet">
      ...
      <section>
        ...
        <div
          rel="v-s:hasBusinessTripRegistrationRecord"
          data-template="gen:BusinessTripRegistrationRecordEmbeddedTemplate"
          data-embedded="true"
      ...
      <section id="DeviationOnExpenses">
        ...
        <div
          rel="gen:hasDeviationOnExpenses"
          data-template="gen:DeviationOnExpensesEmbeddedTemplate"
          data-embedded="true"
          class="-view -edit search create"></div>
      </section>
      <hr />
