...
export const pre = function (individual, template, container, mode, extra) {
  ...
  if (mode === "edit" && individual.hasValue("v-wf:processedDocument")) {
    ...
    individual[complex+'examination'][0][simple+'participant'] = individual[complex+'examination'][0][simple+'participant'].concat(new IndividualModel("d:org_RU1100220011_position_4")); // ЮРО
    individual[complex+'examination'][0][simple+'participant'] = individual[complex+'examination'][0][simple+'participant'].concat(new IndividualModel("d:org_RU1100220011_position_10")); // кадры
    individual[complex+'examination'][0][simple+'participant'] = individual[complex+'examination'][0][simple+'participant'].concat(new IndividualModel("d:org_RU1100220011_position_7")); // бухгалтерия
