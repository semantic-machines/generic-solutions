...
export const html = `
  <div class="container sheet">
    ...
    <div
      rel="v-s:hasContractorCategoryDecisionSecurity"
      class="view edit -search"
      data-template="gen:ContractorCategoryDepartmentDecisionEmbeddedTemplate"></div>
    ...
    <div
      rel="v-s:hasContractorCategoryDecisionFinancial"
      class="view edit -search"
      data-template="gen:ContractorCategoryDepartmentDecisionEmbeddedTemplate"></div>
    <div
      rel="v-s:hasContractorCategoryDecisionManagement"
      class="view edit -search"
      data-template="gen:ContractorCategoryDepartmentDecisionEmbeddedTemplate"></div>
    <div class="row">
      <div class="clearfix view -edit -search col-md-3 col-md-offset-9">
        <button
          id="add-ContractorCategoryDecisionSecurity"
          class="btn btn-success btn-block"
          about="v-s:hasContractorCategoryDecisionSecurity"
          property="rdfs:label"></button>
        <button
          id="add-ContractorCategoryDecisionLegal"
          class="btn btn-success btn-block"
          about="v-s:hasContractorCategoryDecisionLegal"
          property="rdfs:label"></button>
        <button
          id="add-ContractorCategoryDecisionFinancial"
          class="btn btn-success btn-block"
          about="v-s:hasContractorCategoryDecisionFinancial"
          property="rdfs:label"></button>
        <button
          id="add-ContractorCategoryDecisionManagement"
          class="btn btn-success btn-block"
          about="v-s:hasContractorCategoryDecisionManagement"
          property="rdfs:label"></button>
      </div>
    </div>
